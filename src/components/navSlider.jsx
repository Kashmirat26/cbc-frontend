...
export default function NavSlider(props) {
    ...
    return (
        <div className="fixed w-full h-screen z-[10] border-[3px] border-red-900 lg:hidden">
            <div className="bg-white flex flex-col w-[300px] h-screen">
                <div className="bg-gray-100 w-full h-[100px] relative flex items-center justify-center">
